 ...
 */
final class Version20230114203949 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produits (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, user_id INT NOT NULL, photo VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, descreption VARCHAR(255) NOT NULL, couchage VARCHAR(255) NOT NULL, ariver DATETIME NOT NULL, depart DATETIME NOT NULL, ville VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, INDEX IDX_BE2DDF8C12469DE2 (category_id), INDEX IDX_BE2DDF8CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, produit_id INT NOT NULL, nom VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, quantity INT NOT NULL, reference VARCHAR(255) NOT NULL, total DOUBLE PRECISION NOT NULL, INDEX IDX_42C84955A76ED395 (user_id), UNIQUE INDEX UNIQ_42C84955F347EFB (produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
